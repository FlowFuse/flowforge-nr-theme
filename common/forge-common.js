            ...
            mutationsList.forEach(function (mutation) {
                mutation.addedNodes.forEach(function (addedNode) {
                    ...
                    if (el.is('img')) {
                        ...
                        observer.disconnect()
                        const ownerHref = el.parent().prop('href')

                        // set a timeout to comeback and add menu items.
                        // This is far from ideal but there is no events in node-red to
                        // tell us the editor is fully loaded.
                        // additionally, this is a workaround until menus can be themed
                        setTimeout(() => {
                            // update login dialog
                            // eslint-disable-next-line quotes
